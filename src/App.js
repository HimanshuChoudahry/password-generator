...
const App = () => {
  ...
  const handleGeneratePassword = () => {
    ...
    if (passwordLength < 1) notify("Password length must be greater than 0", true);
  ...
  const handleCopyPassword = () => {
    if (password === "") {
      notify("Password has not been copied to clipboard", true);
    }
    else {
        ...
        <div className="generator">
          ...
          <div className="generator__password">
            ...
            <button className="copy__btn">
              <i onClick={handleCopyPassword} className="far fa-copy"></i>
            </button>
          </div>
